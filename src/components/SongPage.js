  ...
  const Home = () => (
    <div className="home-container">
      <h3>
        ...
        and make it into a little book for you. But then, I thought about putting my computer science skills to the test (ngl, chatgpt and I were locked in for this one 🤞). 
        ...
        have the official English translations. Others, I had to translate myself, so they might be a little off). 
        Then, at the bottom of the lyrics is why I chose this song for us. I hope you like your gift, baby. I love you, you and only you. Happy one year, my love❤️!
      </h3>
    </div>
  );
