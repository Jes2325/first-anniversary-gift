function Home() {
  return (
    <div className="home-container">
      <h3> Happy One Year Anniversary, my love! There were many ideas I had on what to gift you, but this I think is a nice touch. I was originally going to hand write all this
